                            ...
                            <div class="card-body col-lg-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                            ...
                                            <button class="btn btn-primary" type="submit" style="width: 10em">Add Space</button>
                                            <a href="{{url()->previous()}}" class="btn btn-default" role="button" style="width: 10em" aria-pressed="true">Cancel</a>
